...
bool RegulatedPurePursuitController::isCollisionImminent(
  ...
  [[maybe_unused]] const double & carrot_dist)
{
  ...
  [[maybe_unused]] const geometry_msgs::msg::Point & robot_xy = robot_pose.pose.position;
  ...
  const geometry_msgs::msg::PoseStamped & pose)
{
  ...
  auto transformation_end =
    nav2_util::geometry_utils::first_after_integrated_distance(
    transformation_begin, global_plan_.poses.end(), max_costmap_extent);
