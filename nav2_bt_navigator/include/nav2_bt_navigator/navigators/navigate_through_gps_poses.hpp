...
#define NAV2_BT_NAVIGATOR__NAVIGATORS__NAVIGATE_THROUGH_GPS_POSES_HPP_
 ...
 * @brief A navigator for navigating through a series of GPS poses
 */
class NavigateThroughGPSPosesNavigator
  : public nav2_bt_navigator::Navigator<nav2_msgs::action::NavigateThroughGPSPoses>
{
public:
...
protected:
   ...
   * Converts GPS poses to map frame poses and stores them
   */
